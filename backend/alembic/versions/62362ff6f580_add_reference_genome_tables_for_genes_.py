...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("ensembl_name", sa.String(50), comment="Ensembl assembly name"),
        sa.Column("ncbi_name", sa.String(100), comment="NCBI assembly accession"),
        sa.Column(
            "version", sa.String(20), comment="Assembly version/patch (e.g., 'p14')"
        ),
        sa.Column(
            "release_date", sa.DateTime(timezone=True), comment="Official release date"
        ),
        sa.Column(
            "is_default",
            sa.Boolean,
        ...
        sa.Column("source_url", sa.Text, comment="URL to assembly information page"),
        sa.Column("extra_data", JSONB, comment="Additional assembly extra_data"),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        "ix_reference_genomes_is_default", "reference_genomes", ["is_default"]
    )
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(255), nullable=False, comment="Full gene name"),
        sa.Column(
            "chromosome",
            sa.String(10),
            nullable=False,
        ...
        sa.Column(
            "strand", sa.String(1), nullable=False, comment="DNA strand ('+' or '-')"
        ),
        sa.Column("genome_id", UUID(as_uuid=True), nullable=False),
        sa.Column("ensembl_id", sa.String(50), comment="Ensembl gene ID"),
        sa.Column("ncbi_gene_id", sa.String(50), comment="NCBI Gene ID"),
        sa.Column("hgnc_id", sa.String(50), comment="HGNC ID"),
        sa.Column("omim_id", sa.String(50), comment="OMIM ID"),
        sa.Column(
            "source",
            sa.String(50),
            nullable=False,
        ...
        sa.Column("source_version", sa.String(50), comment="Source database version"),
        sa.Column("source_url", sa.Text, comment="URL to source record"),
        sa.Column("extra_data", JSONB, comment="Additional gene extra_data"),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.func.now(),
        ...
        sa.ForeignKeyConstraint(
            ["genome_id"], ["reference_genomes.id"], ondelete="CASCADE"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "cds_start", sa.Integer, comment="CDS start position (genomic coordinates)"
        ),
        sa.Column(
            "cds_end", sa.Integer, comment="CDS end position (genomic coordinates)"
        ),
        sa.Column("exon_count", sa.Integer, nullable=False, comment="Number of exons"),
        ...
        sa.Column("source_url", sa.Text, comment="URL to transcript record"),
        sa.Column("extra_data", JSONB, comment="Additional transcript extra_data"),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.func.now(),
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), primary_key=True),
        sa.Column(
            "exon_number", sa.Integer, nullable=False, comment="Exon number (1-based)"
        ),
        sa.Column(
            "chromosome",
            sa.String(10),
        ...
        sa.Column("phase", sa.Integer, comment="Reading frame phase (0, 1, or 2)"),
        sa.Column("transcript_id", UUID(as_uuid=True), nullable=False),
        sa.Column("source", sa.String(50), nullable=False, comment="Data source"),
        sa.Column("extra_data", JSONB, comment="Additional exon extra_data"),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.func.now(),
    ...
    op.create_table(
        ...
        sa.Column(
            "short_name", sa.String(50), comment="Short domain name (e.g., 'POU-S')"
        ),
        sa.Column(
            "start",
            sa.Integer,
        ...
        sa.Column(
            "length", sa.Integer, nullable=False, comment="Domain length (amino acids)"
        ),
        sa.Column("pfam_id", sa.String(50), comment="Pfam identifier"),
        sa.Column("interpro_id", sa.String(50), comment="InterPro identifier"),
        sa.Column("uniprot_id", sa.String(50), comment="UniProt accession"),
        sa.Column("function", sa.Text, comment="Domain function description"),
        sa.Column("transcript_id", UUID(as_uuid=True), nullable=False),
        sa.Column(
            "source",
            sa.String(50),
        ...
        sa.Column("source_url", sa.Text, comment="URL to domain annotation"),
        sa.Column("extra_data", JSONB, comment="Additional domain extra_data"),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.func.now(),
    ...
    op.create_index(
        "ix_protein_domains_interpro_id", "protein_domains", ["interpro_id"]
    )
    op.create_index("ix_protein_domains_uniprot_id", "protein_domains", ["uniprot_id"])
    op.create_index(
        "ix_protein_domains_transcript_id", "protein_domains", ["transcript_id"]
    )
