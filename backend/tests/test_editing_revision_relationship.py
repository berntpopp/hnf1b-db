...
@pytest.mark.asyncio
async def test_editing_revision_lazy_none_when_id_null(db_session, published_record):
...
@pytest.mark.asyncio
async def test_editing_revision_resolves_when_set(
    db_session, admin_user, published_record
):
