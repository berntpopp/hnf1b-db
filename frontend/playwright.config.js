...
// out of Chromium. Match the spec name whether Playwright supplies a path
// relative to testDir or one that still includes parent segments.
const FIREFOX_A11Y_FILE_RE = /(?:^|\/)accessibility\.spec\.js$/;
